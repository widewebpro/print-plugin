 ...
 * @since     1.0.0
 */
class MarketingBuilderVariable
{
    // Public Methods
    // =========================================================================
    ...
    {
        $marketing = (new Query())->select("*")->from('{{%print_marketing_builder}}')->all();
    ...
    {
        $marketing = (new Query())->select("*")->from('{{%print_marketing_builder}}')->where(['id' => $id])->one();
